...
const options = {
  credentials: {
    apiKey: "46748292", //Replace with your OpenTok API key
    sessionId: "2_MX40Njc0ODI5Mn5-MTU5MDM4OTIxODYzMn5Bc25kTTdmNjFUZUpHZng5WmZteFFrcE9-UH4", //Replace with a generated Session ID
    token: "T1==", //Replace with a generated token (from the dashboard or using an OpenTok server SDK)
  },
...
const app = () => {
  ...
  const updateVideoContainers = () => {
    ...
    document
      .getElementById("appVideoContainer")
      .setAttribute("class", videoContainerClass);

    const cameraPublisherClass = `video-container ${
      !!activeCameraSubscribers ? "small" : ""
    } ${!!activeCameraSubscribers ? "small" : ""}`;
    document
      .getElementById("cameraPublisherContainer")
      .setAttribute("class", cameraPublisherClass);

    const cameraSubscriberClass = `video-container ${
      !activeCameraSubscribers ? "hidden" : ""
    } active-${activeCameraSubscribers}`;
    document
      .getElementById("cameraSubscriberContainer")
      .setAttribute("class", cameraSubscriberClass);
  };
  ...
  const createEventListeners = () => {
    ...
    document
      .getElementById("toggleLocalAudio")
      .addEventListener("click", toggleLocalAudio);
    document
      .getElementById("toggleLocalVideo")
      .addEventListener("click", toggleLocalVideo);
    document
      .getElementById("toggleEndCall")
      .addEventListener("click", toggleEndCall);
  };
